      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            <li class="active">
              <a href="" style = "background-color: #7EC4CF; color: white;">Employee</a>
            </li>
            <li>
        ...
        <br>
          <div class="well bs-component" style="background-color: #DAF7A6; color: black;">
                ...
                <div class="table-responsive">
                  <form method="post" action="" >
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      <!-- <h3><b>Ordinance</b></h3> -->
                      <thead style="background-color: #6F8FAF; color: black;">
                        <tr class="info" style="background-color: #6F8FAF; color: black;">
                          <th style="background-color: #16A085; border: 1px solid black; color: white;"><p align="center">Name</p></th>
                          <th style="background-color: #16A085; border: 1px solid black; color: white;"><p align="center">Gender</p></th>
                          <th style="background-color: #16A085; border: 1px solid black; color: white;"><p align="center">Employee Type</p></th>
                          <th style="background-color: #16A085; border: 1px solid black; color: white;"><p align="center">Department</p></th>
                          <th style="background-color: #16A085; border: 1px solid black; color: white;"><p align="center">Action</p></th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
