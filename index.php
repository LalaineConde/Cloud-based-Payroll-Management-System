      ...
      <div class="masthead">
        <h3 style = "color: white;">
          <b>Payroll Management System</b>
            <a data-toggle="modal" href="#colins" class="pull-right" style = "color: white;"><b><?php echo $_SESSION['username']; ?></b></a>
        </h3>
        <nav>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <div align="center">
                <a href="https://www.facebook.com/catipay.mustjc" target="_blank" title="My Instructor in OOP2"><big><b>Mr. Joseph L. Domingo</b></big></a>
              </div>
            </div>
          </div>
        </div>
