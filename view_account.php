...
<html lang="en">
  ...
  <body style="background-color: #6F8FAF; color: white;">
      ...
      <?php
        ...
        while ($row = mysqli_fetch_assoc($result))
        {
          ...
          ?>
            ...
            <div style = "background-color: #16A085; border: 1px solid black;">
              <form class="form-horizontal" action="update_account.php" method="post" name="form">
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div style="text-align: center;">
                    <table class ="table table condensed" style="width: 80%; background: #DAF7A6; color: black; border: 1px solid black; margin: auto;">
                      
                        <td style="width: 50%; border: 1px solid black;"><strong>Net Pay</strong></td>
                        <td style="width: 50%; border: 1px solid black;"><strong><?php echo $netpay;?>.00</strong></td>
                      </tr>
                    </table>
                  </div>
