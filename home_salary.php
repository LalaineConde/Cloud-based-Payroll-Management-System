      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active">
              <a href="" style = "background-color: #7EC4CF; color: white;">Income</a>
            </li>
          </ul>
        </nav>
      </div>
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <thead style="background-color: #6F8FAF; color: black;">
                        <tr class="info" style="background-color: #6F8FAF; color: black;">
                          <th style="background-color: #16A085; color: white; border: 1px solid black;"><p align="center">Name</p></th>
                          <th style="background-color: #16A085; color: white; border: 1px solid black;"><p align="center">Deduction</p></th>
                          <th style="background-color: #16A085; color: white; border: 1px solid black;"><p align="center">Overtime</p></th>
                          <th style="background-color: #16A085; color: white; border: 1px solid black;"><p align="center">Bonus</p></th>
                          <th style="background-color: #16A085; color: white; border: 1px solid black;"><p align="center">Net Pay</p></th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
